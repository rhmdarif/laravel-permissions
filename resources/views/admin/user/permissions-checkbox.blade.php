        ...
        <div class="col-md-4 mb-4 align-self-stretch ">
            ...
            @foreach ($permissions as $permission)
                <div class="form-check mx-2">
                    <input class="form-check-input m-{{ $module }}" type="checkbox" name="permissions[]" value="{{ $permission->id }}" id="permission-{{ $permission->id }}" @checked($user->hasRole("Super Admin") || in_array($permission->id, $all_permissions))>
